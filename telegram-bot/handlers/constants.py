...
class EmployeeCreateMessages(Enum):
    ...
    CANCEL = "❌ Вы отменили создание нового сотрудника"
    SUCCESS = "✅ Отлично! Вы успешно создали пользователя!"
    STOPPED = "❌ Заполнение прервано. Все данные сброшены."


class EmployeeUpdateMessages(Enum):
    INVALID_ID = "❌ Вы ввели некорректный ID, или такого не работника не существует"
    UPDATE = "🪪 Давайте обновим карточку нового сотрудника!"
    CANCEL = "❌ Вы отменили обновление карточки сотрудника"
    SUCCESS = "✅ Отлично! Вы успешно обновили пользователя!"
    STOPPED = "❌ Заполнение прервано. Все данные сброшены."
