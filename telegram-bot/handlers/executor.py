...
async def process_name(message: types.Message, state: FSMContext):
    ...
    await message.answer(UserAddMessages.USER_ADD_MESSAGE_FILLING_PATRONYMIC.value)
...
async def process_patronymic(message: types.Message, state: FSMContext):
    ...
    await message.answer(UserAddMessages.USER_ADD_MESSAGE_FILLING_SURNAME.value)
    await FillEmployee.next()
...
async def process_project(message: types.Message, state: FSMContext):
    ...
    await message.answer(UserAddMessages.USER_ADD_MESSAGE_FILLING_AVATAR.value)
    await FillEmployee.next()
...
async def process_avatar(message: types.Message, state: FSMContext):
    ...
    await message.answer(UserAddMessages.USER_ADD_MESSAGE_FILLING_DONE.value)
